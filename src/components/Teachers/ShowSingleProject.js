  ...
  const formSubmit = async (e) => {
    ...
    try {
      const response = await axios.patch(
        `https://student-project-management.herokuapp.com/projects/update-project?teacherId=${
          user ? user._id : "12"
        }`,
        newProject,
        { headers }
          ...
          <div className="py-4 bg-white rounded-md">
            <form
              onSubmit={async (e) => {
                ...
                try {
                  const response = await axios.patch(
                    `https://student-project-management.herokuapp.com/projects/add-task?teacherId=${
                      user ? user._id : "12"
                    }`,
                    {
                      task: task,
          ...
          <div className="py-4 bg-white rounded-md">
            <form
              ...
              onSubmit={async (e) => {
                ...
                try {
                  const response = await axios.patch(
                    `https://student-project-management.herokuapp.com/projects/add-task-marks?teacherId=${
                      user ? user._id : "12"
                    }`,
                    {
                      marks: marks,
          ...
          <div className="py-4 bg-white rounded-md">
            <form
              ...
              onSubmit={async (e) => {
                ...
                try {
                  const response = await axios.patch(
                    `https://student-project-management.herokuapp.com/projects/add-task-remark?teacherId=${
                      user ? user._id : "12"
                    }`,
                    {
                      remark: remark,
