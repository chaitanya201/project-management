...
export default function ShowSingleProject() {
  ...
  const uploadPPT = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(
        `https://student-project-management.herokuapp.com/projects/upload-ppt?studentId=${
          user ? user._id : "123"
        }`,
  ...
  const uploadReport = async (e) => {
    ...
    try {
      ...
      console.log(url);
      const response = await axios.patch(
        `https://student-project-management.herokuapp.com/projects/upload-report?studentId=${
          user ? user._id : "123"
        }`,
  ...
  const uploadLiteratureReview = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(
        `https://student-project-management.herokuapp.com/projects/upload-literature-review?studentId=${
          user ? user._id : "123"
        }`,
