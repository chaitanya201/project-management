  ...
  const getAllProjects = async () => {
    try {
      const response = await axios.get(
        "https://student-project-management.herokuapp.com/projects/get-all-pending-projects?studentId=" +
          cookies.user._id +
          "&year=" +
          year.value +
          "&subject=" +
                ...
                onSubmit={async (e) => {
                  ...
                  try {
                    const response = await axios.patch(
                      "https://student-project-management.herokuapp.com/projects//student-update-project-title",
            ...
            <div className=" ml-10 mr-32 bg-white rounded-2xl w-80  ">
              <form
                ...
                onSubmit={async (e) => {
                  ...
                  try {
                    const response = await axios.patch(
                      "https://student-project-management.herokuapp.com/projects//student-update-project-abstract",
