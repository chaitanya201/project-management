                ...
                <li className="p-4">
                  <button
                    onClick={async () => {
                      ...
                      try {
                        await axios.get(
                          "https://student-project-management.herokuapp.com/student/logout",
                ...
                <li className="p-4">
                  <button
                    onClick={async () => {
                      ...
                      try {
                        await axios.get(
                          "https://student-project-management.herokuapp.com/admin/logout",
                          {
                            headers,
                ...
                <li className="p-4">
                  <button
                    onClick={async () => {
                      ...
                      try {
                        await axios.get(
                          "https://student-project-management.herokuapp.com/teacher/logout",
                          { headers, withCredentials: true }
                        );
                        dispatch(changeUser(null));
